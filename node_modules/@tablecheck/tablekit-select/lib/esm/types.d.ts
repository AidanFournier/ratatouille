...
export interface SelectProps<OptionType extends OptionTypeBase = {
    label: string;
    value: string;
}, IsMulti extends boolean = false, GroupType extends GroupTypeBase<OptionType> = GroupTypeBase<OptionType>> extends Props<OptionType, IsMulti, GroupType> {
...
export declare type ButtonDropdownPropsType = SelectProps & {
