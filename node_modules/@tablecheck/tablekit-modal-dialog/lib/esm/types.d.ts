...
export declare type AllowedModalWidth = Size.Small | Size.Regular | Size.Large | Size.XLarge;
export declare enum HeaderAppearance {
    Warning = "warning",
    Danger = "danger"
}
...
export declare type BaseModalProps = ControlledModalProps & {
    ['data-testid']?: string;
