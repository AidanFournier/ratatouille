...
var _AnimatedContent = require("./components/AnimatedContent.js");

var _ModalHeader = require("./components/ModalHeader.js");
...
var ModalDialog = function ModalDialog(props) {
  ...
  var onOpenChangeHandler = (0, _react.useCallback)(function (state) {
    if (onOpenChange) {
      onOpenChange(state);
    } else {
  ...
  return (0, _jsxRuntime.jsxs)(_styled.ModalRoot, {
    onOpenChange: onOpenChangeHandler,
    open: isModalOpen,
    children: [trigger ? (0, _jsxRuntime.jsx)(_reactDialog.Trigger, {
      asChild: true,
      children: trigger
    }) : null, (0, _jsxRuntime.jsxs)(_AnimatedContent.AnimatedContent, {
      className: className,
      isOpen: isModalOpen,
      height: height,
      width: width,
      ...
      "data-testid": testId,
      children: [typeof headerContent !== 'undefined' ? (0, _jsxRuntime.jsx)(_ModalHeader.ModalHeader, {
        hasKeyline: hasKeylines,
        hasCloseIcon: hasCloseIcon,
        appearance: headerAppearance,
        children: typeof headerContent === 'string' ? (0, _jsxRuntime.jsx)(_styled.ModalTitle, {
          children: headerContent
        }) : headerContent
      }) : null, (0, _jsxRuntime.jsx)(_styled.ModalBody, {
        hasGutters: !shouldHideGutters,
        isScrollable: true,
        children: children
      }), footerContent ? (0, _jsxRuntime.jsx)(_styled.FooterWrapper, {
        hasKeyline: hasKeylines,
