...
export declare type PlacementType = Placement;
export interface ChildRenderProps {
    isOpen: boolean;
    onClose: () => void;
}
export interface InlineDialogProps<TriggerElement extends HTMLElement> extends HTMLAttributes<HTMLDivElement> {
