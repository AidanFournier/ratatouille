...
import { InlineDialogContainer, Container } from './styled.js';
...
function InlineDialog(_ref) {
  ...
  return jsx(InlineDialogContainer, {
    className: className,
    children: jsxs(Manager, {
      children: [jsx(Reference, {
      ...
      }), isOpen && jsx(Popper, _objectSpread(_objectSpread({}, correctedPopperProps), {}, {
        children: function children(_ref4) {
          var _ref5 = _ref4.ref,
              style = _ref4.style;
          return jsx(Container, _objectSpread(_objectSpread({}, restProps), {}, {
            css: containerCss,
            ref: function ref(node) {
