...
var SvgSymbolBase = function SvgSymbolBase(_ref) {
...
var LogoSymbol = /*#__PURE__*/(0, _base.default)(SvgSymbolBase, process.env.NODE_ENV === "production" ? {
  target: "edx13dn0"
} : {
  target: "edx13dn0",
  label: "LogoSymbol"
  ...
  var isDarkTheme = _ref4.isDarkTheme,
      theme = _ref4.theme;
  var isDark = typeof isDarkTheme === 'undefined' ? theme === null || theme === void 0 ? void 0 : theme.isDark : isDarkTheme;
  return isDark ? 'white' : _tablekitTheme.COLORS.PURPLE.L5;
}, ";");
exports.LogoSymbol = LogoSymbol;
