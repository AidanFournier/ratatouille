...
var SvgWordingBase = function SvgWordingBase(_ref) {
...
var LogoWording = /*#__PURE__*/(0, _base.default)(SvgWordingBase, process.env.NODE_ENV === "production" ? {
  ...
  var size = _ref2.size;
  return size;
}, ";margin-left:", _tablekitTheme.Spacing.L2, ";color:", function (_ref3) {
  var isDarkTheme = _ref3.isDarkTheme,
      theme = _ref3.theme;
  var isDark = typeof isDarkTheme === 'undefined' ? theme === null || theme === void 0 ? void 0 : theme.isDark : isDarkTheme;
  return isDark ? 'white' : _tablekitTheme.COLORS.GRAY.L8;
}, ";", (0, _tablekitUtils.mediaQuery)('display', function (value) {
  return "display: ".concat(value || 'block');
}), ";");
exports.LogoWording = LogoWording;
