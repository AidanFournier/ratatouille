...
var LogoWording = /*#__PURE__*/_styled(SvgWordingBase, process.env.NODE_ENV === "production" ? {
  target: "e1fb7qbx0"
} : {
  target: "e1fb7qbx0",
  label: "LogoWording"
  ...
  var size = _ref2.size;
  return size;
}, ";margin-left:", Spacing.L2, ";color:", function (_ref3) {
...
}, ";", mediaQuery('display', function (value) {
