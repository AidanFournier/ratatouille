...
export interface PanelProps extends CommonPanelProps, HTMLAttributes<HTMLDivElement> {
    /** panel's height with mediaQueries */
    height?: MediaQuery<string>;
    /** panel's width with mediaQueries */
    width?: MediaQuery<string>;
}
export interface ResizablePanelProps extends CommonPanelProps, Pick<ResizableProps, 'maxWidth' | 'maxHeight' | 'minHeight' | 'minWidth'> {
...
export declare type PanelContainerProps = Omit<PanelProps, 'togglePanel' | 'onClickOutside'>;
export declare type ResizablePanelContainerProps = Omit<ResizablePanelProps & ResizableProps, 'togglePanel' | 'onClickOutside' | 'defaultHeight' | 'defaultWidth'>;
export {};
