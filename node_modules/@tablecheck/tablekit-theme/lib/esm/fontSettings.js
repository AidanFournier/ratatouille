import { plexSansFont } from './fonts/plexSans.js';
import { plexSansArabicFont } from './fonts/plexSansArabic.js';
import { plexSansThaiLoopedFont } from './fonts/plexSansThaiLooped.js';
import { FontWeight } from './fonts/weights.js';
...
var getFont = function getFont(casedLocale, casedCountry, paramFontWeights) {
  ...
  if (locale === 'th' || country === 'th') {
    return plexSansThaiLoopedFont(fontWeights);
  }

  if (locale === 'ar' || AR_COUNTRIES.includes(country)) {
    return plexSansArabicFont(fontWeights);
  }

  return plexSansFont(fontWeights);
};
...
export { getFont, getFontFamily, resolveFontWeights };
