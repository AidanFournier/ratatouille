...
export declare enum ItemBorderPosition {
    Left = "left",
    Right = "right",
    Top = "top",
    Bottom = "bottom"
}
export declare enum ItemInteractionState {
    Default = "default",
    Hidden = "hidden",
    Selected = "selected",
    Disabled = "disabled"
}
declare type ComponentProps<Component extends React.ElementType> = {
...
export declare type ItemProps<Component extends React.ElementType> = BaseItemProps & ComponentProps<Component>;
...
export declare type ItemContainerProps<Component extends ElementType> = ItemProps<Component> & {
    hasOnlyIcon: boolean;
    interactionState?: ItemInteractionState;
};
export declare enum ItemGroupOrientation {
