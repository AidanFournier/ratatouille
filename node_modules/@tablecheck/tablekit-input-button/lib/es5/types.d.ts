...
declare type OnChangeHandler = (event: React.SyntheticEvent<HTMLInputElement>) => unknown;
export declare type InputButtonProps = Omit<HTMLAttributes<HTMLInputElement>, 'id'> & {
    id: string;
} & Partial<{
